					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/firaun.tiktok/" class="hover:underline">
										ESTA
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/sttaaaaaaaaaaa/" class="hover:underline">
										ALGA
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/exierpeel.two/" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://www.youtube.com/c/SMKN1Cibinong_Official" class="hover:underline">
										Youtube
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XI RPL 2 | Di Kelola Oleh Siswa RPL2
						</p>
					</div>
				</div>
			</div>
